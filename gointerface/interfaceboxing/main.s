...
"".main STEXT size=311 args=0x0 locals=0x88 funcid=0x0
	...
	0x0026 00038 (main.go:18)	FUNCDATA	$0, gclocals·7d2d5fca80364273fb07d5820a76fef4(SB)
	0x0026 00038 (main.go:18)	FUNCDATA	$1, gclocals·5281ddd282d2ee46e64efba251339d2f(SB)
	0x0026 00038 (main.go:18)	FUNCDATA	$2, "".main.stkobj(SB)
	...
	0x0055 00085 (main.go:28)	MOVQ	AX, ""..autotmp_42+64(SP)
	0x005a 00090 (main.go:28)	MOVQ	BX, "".ei.data+48(SP)
	...
	0x008e 00142 (main.go:29)	MOVQ	AX, ""..autotmp_43+56(SP)
	0x0093 00147 (main.go:29)	MOVQ	BX, "".i.data+40(SP)
	0x0098 00152 (main.go:28)	MOVUPS	X15, ""..autotmp_19+88(SP)
	0x009e 00158 (main.go:28)	MOVQ	""..autotmp_42+64(SP), CX
	0x00a3 00163 (main.go:28)	MOVQ	CX, ""..autotmp_19+88(SP)
	0x00a8 00168 (main.go:28)	MOVQ	"".ei.data+48(SP), CX
	0x00ad 00173 (main.go:28)	MOVQ	CX, ""..autotmp_19+96(SP)
	...
	0x00d5 00213 (main.go:29)	MOVQ	""..autotmp_43+56(SP), CX
	0x00da 00218 (main.go:29)	TESTQ	CX, CX
	0x00dd 00221 (main.go:29)	JEQ	229
	0x00df 00223 (main.go:29)	MOVQ	8(CX), AX
	0x00e3 00227 (main.go:29)	JMP	232
	0x00e5 00229 (main.go:29)	MOVQ	CX, AX
	0x00e8 00232 (main.go:29)	MOVUPS	X15, ""..autotmp_23+72(SP)
	0x00ee 00238 (main.go:29)	MOVQ	AX, ""..autotmp_23+72(SP)
	0x00f3 00243 (main.go:29)	MOVQ	"".i.data+40(SP), DX
	0x00f8 00248 (main.go:29)	MOVQ	DX, ""..autotmp_23+80(SP)
	...
	0x011d 00285 (main.go:30)	MOVQ	128(SP), BP
	0x0125 00293 (main.go:30)	ADDQ	$136, SP
	0x012c 00300 (main.go:30)	RET
	0x012d 00301 (main.go:30)	NOP
	0x012d 00301 (main.go:18)	PCDATA	$1, $-1
	0x012d 00301 (main.go:18)	PCDATA	$0, $-2
	0x012d 00301 (main.go:18)	CALL	runtime.morestack_noctxt(SB)
	0x0132 00306 (main.go:18)	PCDATA	$0, $-1
	0x0132 00306 (main.go:18)	JMP	0
